...
class FetchPickAndPlaceEasyEnv(fetch_env.FetchEnv, utils.EzPickle):
    ...
    def __init__(self, reward_type='sparse'):
        ...
        fetch_env.FetchEnv.__init__(
            ...
            gripper_extra_height=0.15, target_in_the_air=True, target_offset=0.0,
            obj_range=0.0, target_range=0.15, distance_threshold=0.05,
            initial_qpos=initial_qpos, reward_type=reward_type)
        utils.EzPickle.__init__(self)
