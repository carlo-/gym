...
register(
    id='GaussianPendulum-v0',
    entry_point='gym.envs.classic_control:GaussianPendulumEnv',
    max_episode_steps=200,
)
...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchPickAndPlaceEasy{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceEasyEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='FetchPushSphere{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushSphereEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='MovingHandReach{}-v0'.format(suffix),
        entry_point='gym.envs.robotics:MovingHandReachEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
